...
?>
<h3 class="card-title">รายชื่อผู้ดูแลระบบ 
	<a href="index.php?act=add" class="btn btn-primary btn-sm">+เเจ้งซ่อม
	</a>
</h3>
...
<table id="example2" class="table table-bordered table-striped table-hover table-sm">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="index.php?id=<?=$row['case_id'];?>&act=detail" class="btn btn-info btn-sm">เปิดดู</a>
		</td>
